...
#let emailIcon(
  ...
  let emailSvg = ```<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#888888"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>```.text
  if (email == none) { return }
  link("mailto:" + email)[#box(height: 0.8em, baseline: 13.5%)[#image(bytes(emailSvg))]]
}
...
#let validateAuthor(raw) = {
  ...
  let equal_contributor = validateBoolean(raw, "equal_contributor", alias: ("equal-contributor", "equalContributor"))
  if (equal_contributor != none) { out.equal_contributor = equal_contributor }
